...
import com.example.backendtools.products.application.RankProducts.RankedProduct;
...
class RankProductsTest {
    @Mock
    private ProductRepository productRepository;

    private RankProducts rankProducts;
    ...
    void setUp() {
        ...
        rankProducts = new RankProducts(productRepository, criteria);
    }
    ...
    void shouldReturnProductsRankedByWeightedScore() {
        ...
        // Act
        List<RankedProduct> rankedProducts = rankProducts.execute(weights);
